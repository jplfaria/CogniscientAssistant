...
class BamlStreamClient:
    ...
    def CalculateSimilarity(self, hypothesis1: types.Hypothesis,hypothesis2: types.Hypothesis,similarity_aspects: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.SimilarityScore, types.SimilarityScore]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="CalculateSimilarity", args={
            "hypothesis1": hypothesis1,"hypothesis2": hypothesis2,"similarity_aspects": similarity_aspects,
        })
        return baml_py.BamlStream[stream_types.SimilarityScore, types.SimilarityScore](
          result,
    ...
    def CompareHypotheses(self, hypothesis1: types.Hypothesis,hypothesis2: types.Hypothesis,comparison_criteria: typing.List[str],debate_context: typing.Optional[str] = None,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ComparisonResult, types.ComparisonResult]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="CompareHypotheses", args={
            "hypothesis1": hypothesis1,"hypothesis2": hypothesis2,"comparison_criteria": comparison_criteria,"debate_context": debate_context,
        })
        return baml_py.BamlStream[stream_types.ComparisonResult, types.ComparisonResult](
          result,
    ...
    def EnhanceHypothesis(self, original_hypothesis: types.Hypothesis,enhancement_strategy: str,feedback: typing.Optional[typing.List[str]] = None,complementary_hypothesis: typing.Optional["types.Hypothesis"] = None,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.Hypothesis, types.Hypothesis]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="EnhanceHypothesis", args={
            "original_hypothesis": original_hypothesis,"enhancement_strategy": enhancement_strategy,"feedback": feedback,"complementary_hypothesis": complementary_hypothesis,
        })
        return baml_py.BamlStream[stream_types.Hypothesis, types.Hypothesis](
          result,
    ...
    def EvaluateHypothesis(self, hypothesis: types.Hypothesis,review_type: types.ReviewType,evaluation_criteria: typing.List[str],context: typing.Optional[typing.Dict[str, str]] = None,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.Review, types.Review]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="EvaluateHypothesis", args={
            "hypothesis": hypothesis,"review_type": review_type,"evaluation_criteria": evaluation_criteria,"context": context,
        })
        return baml_py.BamlStream[stream_types.Review, types.Review](
          result,
    ...
    def ExtractResearchPatterns(self, hypotheses: typing.List["types.Hypothesis"],reviews: typing.List["types.Review"],focus: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ResearchPatterns, types.ResearchPatterns]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractResearchPatterns", args={
            "hypotheses": hypotheses,"reviews": reviews,"focus": focus,
        })
        return baml_py.BamlStream[stream_types.ResearchPatterns, types.ResearchPatterns](
          result,
    ...
    def GenerateHypothesis(self, goal: str,constraints: typing.List[str],existing_hypotheses: typing.List["types.Hypothesis"],focus_area: typing.Optional[str],generation_method: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="GenerateHypothesis", args={
            "goal": goal,"constraints": constraints,"existing_hypotheses": existing_hypotheses,"focus_area": focus_area,"generation_method": generation_method,
        })
        return baml_py.BamlStream[stream_types.Hypothesis, types.Hypothesis](
          result,
    ...
    def ParseResearchGoal(self, natural_language_goal: str,domain_context: typing.Optional[str] = None,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ParsedResearchGoal, types.ParsedResearchGoal]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ParseResearchGoal", args={
            "natural_language_goal": natural_language_goal,"domain_context": domain_context,
        })
        return baml_py.BamlStream[stream_types.ParsedResearchGoal, types.ParsedResearchGoal](
          result,
    ...
    def PerformSafetyCheck(self, target_type: str,target_content: str,trust_level: str,safety_criteria: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.SafetyCheck, types.SafetyCheck]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="PerformSafetyCheck", args={
            "target_type": target_type,"target_content": target_content,"trust_level": trust_level,"safety_criteria": safety_criteria,
        })
        return baml_py.BamlStream[stream_types.SafetyCheck, types.SafetyCheck](
          result,
...
class BamlHttpRequestClient:
    ...
    async def CalculateSimilarity(self, hypothesis1: types.Hypothesis,hypothesis2: types.Hypothesis,similarity_aspects: typing.List[str],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="CalculateSimilarity", args={
            "hypothesis1": hypothesis1,"hypothesis2": hypothesis2,"similarity_aspects": similarity_aspects,
        }, mode="request")
        return result
    async def CompareHypotheses(self, hypothesis1: types.Hypothesis,hypothesis2: types.Hypothesis,comparison_criteria: typing.List[str],debate_context: typing.Optional[str] = None,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="CompareHypotheses", args={
            "hypothesis1": hypothesis1,"hypothesis2": hypothesis2,"comparison_criteria": comparison_criteria,"debate_context": debate_context,
        }, mode="request")
        return result
    async def EnhanceHypothesis(self, original_hypothesis: types.Hypothesis,enhancement_strategy: str,feedback: typing.Optional[typing.List[str]] = None,complementary_hypothesis: typing.Optional["types.Hypothesis"] = None,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="EnhanceHypothesis", args={
            "original_hypothesis": original_hypothesis,"enhancement_strategy": enhancement_strategy,"feedback": feedback,"complementary_hypothesis": complementary_hypothesis,
        }, mode="request")
        return result
    async def EvaluateHypothesis(self, hypothesis: types.Hypothesis,review_type: types.ReviewType,evaluation_criteria: typing.List[str],context: typing.Optional[typing.Dict[str, str]] = None,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="EvaluateHypothesis", args={
            "hypothesis": hypothesis,"review_type": review_type,"evaluation_criteria": evaluation_criteria,"context": context,
        }, mode="request")
        return result
    async def ExtractResearchPatterns(self, hypotheses: typing.List["types.Hypothesis"],reviews: typing.List["types.Review"],focus: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractResearchPatterns", args={
            "hypotheses": hypotheses,"reviews": reviews,"focus": focus,
        }, mode="request")
        return result
    async def GenerateHypothesis(self, goal: str,constraints: typing.List[str],existing_hypotheses: typing.List["types.Hypothesis"],focus_area: typing.Optional[str],generation_method: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="GenerateHypothesis", args={
            "goal": goal,"constraints": constraints,"existing_hypotheses": existing_hypotheses,"focus_area": focus_area,"generation_method": generation_method,
        }, mode="request")
        return result
    async def ParseResearchGoal(self, natural_language_goal: str,domain_context: typing.Optional[str] = None,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ParseResearchGoal", args={
            "natural_language_goal": natural_language_goal,"domain_context": domain_context,
        }, mode="request")
        return result
    async def PerformSafetyCheck(self, target_type: str,target_content: str,trust_level: str,safety_criteria: typing.List[str],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="PerformSafetyCheck", args={
            "target_type": target_type,"target_content": target_content,"trust_level": trust_level,"safety_criteria": safety_criteria,
        }, mode="request")
        return result
